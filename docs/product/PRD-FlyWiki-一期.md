...
> **v1.3 范围校准说明**：本版本依据 2026-08-03 的产品目标与需求审核，把一期从"6-8 人团队交付的完整平台"校准为"个人开发者 + AI 辅助可交付的核心闭环"。个人微信 Edge Device、本地文件同步、分享与访客体系、角色权限、REST/Webhook、Profile Document、基础内容生成等能力移出一期（见 §9）；v1.2 的完整平台愿景保留为二期及以后的演进方向。四篇 ADR 的架构决策在新范围下继续有效。
